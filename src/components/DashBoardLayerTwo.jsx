...
const DashBoardLayerTwo = () => {
  ...
  const getCurrentStepNumber = () => {
    ...
    const stepMap = {
      ...
      'step_5': 5, 'step_6': 6, 'step_7': 7, 'finalize': 8
    };
          ...
          <div className="card-body p-24">
            ...
            <div className="row">
              {Object.keys(dashboardData.steps || {}).map((stepKey) => {
                ...
                const isCurrentStep = dashboardData.summary?.next_step === stepKey;
                  ...
                  <div key={stepKey} className="col-md-6 mb-3">
                    <div className="d-flex align-items-center p-3 rounded border" style={{
                      ...
                      <div className="flex-grow-1">
                        ...
                        {/* Timestamp */}
                        {dashboardData.timestamps && dashboardData.timestamps[stepKey] && (
                          <div className="text-secondary-light text-xs mt-1">
                            {formatTimestamp(dashboardData.timestamps[stepKey])}
                          </div>
                        )}
                      </div>
                    </div>
                ...
                {dashboardData.messages.slice(0, 5).map((message) => (
                  <div key={message.id} className="border-bottom pb-3">
                    <div className="d-flex align-items-start gap-3">
                      ...
                      <div className="flex-grow-1">
                        <div className="fw-semibold text-sm">Message #{message.id}</div>
            ...
            <div className="row g-3">
              <div className="col-md-4">
                ...
                >
                  ...
                  <div className="text-secondary-light text-xs">
                    {dashboardData.summary?.next_step === 'finalize' ? 'Complete your application' : 'Resume where you left off'}
                  </div>
                </button>
              </div>
